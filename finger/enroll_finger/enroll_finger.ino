...
const char *ssid = "Ghost@unifi";  //ENTER YOUR WIFI SETTINGS
const char *password = "Ghost15538";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.1.6/biometricDoorSecurity/getdata.php"; //computer IP or the server domain
...
void SendFingerprintID( int finger ){
  ...
  WiFiClient client;
  http.begin(client, "http://192.168.1.6/biometricDoorSecurity/getdata.php"); //initiate HTTP request, put your Website URL or Your Computer IP 
...
void ChecktoAddID(){
  ...
  WiFiClient client;
  http.begin (client, "http://192.168.1.6/biometricDoorSecurity/getdata.php");
